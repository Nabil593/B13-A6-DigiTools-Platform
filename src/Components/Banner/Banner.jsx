        ...
        <div>
            <div className='w-full max-w-[1200px] lg:px-0 md:px-8 sm:px-6 px-6 mx-auto flex lg:flex-row md:flex-row sm:flex-col flex-col justify-between items-center gap-10 lg:mt-20 md:mt-20 sm:mt-15 mt-15'>
                <div className='max-w-[640px] space-y-4'>
                    ...
                    <h2 className='lg:text-7xl md:text-5xl sm:text-5xl text-5xl font-extrabold text-[#101727] opacity-90 lg:leading-22 md:leading-14 leading-14'>Supercharge Your Digital Workflow</h2>
                    ...
                    <div className='flex items-center gap-4 mt-8'>
                        <button className='px-5 py-3 bg-gradient-to-r from-[#4F39F6] to-[#9514FA] lg:text-[16px] md:text-[14px] sm:text-[14px] text-[14px] font-medium text-white rounded-full cursor-pointer'>Explore Products</button>
